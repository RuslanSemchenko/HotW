...
================
*/
// ÈÑÏÐÀÂËÅÍÈÅ: Èñïîëüçóåì __declspec(dllexport) âìåñòî Q_EXPORT
...
static void CG_RegisterGraphics( void ) {
	...
	cgs.media.e_knife = trap_R_RegisterModel("models/weapons2/knife/knife");
...
void CG_PlayMusic( void ) {
	...
	if ( cg.custommusic ) {  // start custom music
		...
		Q_strncpyz( parm1, trackInfo[trackNum].path, sizeof(parm1) );
		Q_strncpyz( parm2, trackInfo[trackNum].path, sizeof(parm2) );
