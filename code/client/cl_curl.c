...
static int CL_cURL_CallbackXferInfo( void *dummy, curl_off_t dltotal, curl_off_t dlnow,
...
#if LIBCURL_VERSION_NUM >= 0x072000
	qcurl_easy_setopt(clc.downloadCURL, CURLOPT_XFERINFOFUNCTION,
		CL_cURL_CallbackXferInfo);
#else
