...
char* Cmd_Argv(int arg) {
	// —начала провер€ем на отрицательное значение, так как int может быть < 0
	// «атем приводим к size_t дл€ корректного сравнени€ с количеством аргументов
	if (arg < 0 || (size_t)arg >= (size_t)cmd_argc) {
		return "";
	}
	return cmd_argv[arg];
}
...
void Cmd_CompleteCfgName(char* args, int argNum) {
	// ѕодавл€ем варнинг C4100 (неиспользованный параметр)
	(void)args;
