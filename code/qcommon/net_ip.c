// Defines for MSVC to prevent deprecation errors
...
#	if WINVER < 0x501
#		ifdef __MINGW32__
			// wspiapi.h isn't available on MinGW
#			include "wspiapi.h"
#		else
#			include <wspiapi.h>
#		endif
...
void NET_OpenSocks(int port) {
	...
	if (buf[1] == 2) {
		...
		// ИСПРАВЛЕНИЕ: Явное приведение size_t к int для устранения предупреждения C4267
