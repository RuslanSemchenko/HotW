...
#define BASETA				"missionpack"
  ...
  #define PRODUCT_NAME				"Heart of the West"
  #define PRODUCT_SHORTNAME			"HotW"
  #define PRODUCT_URL				"http://www.smokin-guns.org"
  #define BASEGAME					"HotW"
  ...
  #define CLIENT_WINDOW_MIN_TITLE 	"HotW"
  #define HOMEPATH_NAME_UNIX		".HotW"
  #define HOMEPATH_NAME_WIN			PRODUCT_NAME
  #define HOMEPATH_NAME_MACOSX		PRODUCT_SHORTNAME
  #define GAMENAME_FOR_MASTER		"HotW"
