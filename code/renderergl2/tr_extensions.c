...
void GLimp_InitExtraExtensions()
{
	...
	if( GLimp_HaveExtension( extension ) )
	{
		qglMultiDrawArraysEXT = (void (*)(GLenum, GLint *, GLsizei *, GLsizei)) SDL_GL_GetProcAddress("glMultiDrawArraysEXT");
		qglMultiDrawElementsEXT = (void (*)(GLenum, const GLsizei *, GLenum, const GLvoid **, GLsizei)) SDL_GL_GetProcAddress("glMultiDrawElementsEXT");
